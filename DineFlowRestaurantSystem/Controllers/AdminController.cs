...
namespace DineFlowRestaurantSystem.Controllers
{
    public class AdminController : Controller
    {
        ...
        public AdminController(UserService userService, MenuService menuService, OrderService orderService, FeedbackService feedbackService, IngredientService ingredientService)
        {
